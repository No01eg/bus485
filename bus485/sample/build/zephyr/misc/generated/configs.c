...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_STRIM_BUS485_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_WIFI_NRF70_BUSLIB_LOG_LEVEL, 4);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STRIM_BUS485, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STRIM_BUS485_INIT_PRIORITY, 50);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STRIM_BUS485_RX_QUEUE_SIZE, 256);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STRIM_BUS485_TX_QUEUE_SIZE, 256);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STRIM_BUS485_RECV_SYM_IDLE_COUNT, 5);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STRIM_BUS485_LOG_LEVEL, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_BUS485_MODULE, 1);
